...
function enviarEmail() {
  ...
  if (validarEmail(userEmail)) {
      ...
      newMessage.textContent = `O e-mail "${userEmail}" foi enviado. Entraremos em contato em breve.`;
...
function validarEmail(email) {
  // Lógica simples de validação de e-mail. Pode ser expandida conforme necessário.
